      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border-t-4 border-orange-500 p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full h-12 rounded-lg font-bold text-white text-base transition-all shadow-md hover:shadow-lg flex justify-center items-center uppercase tracking-wide ${
              loading
